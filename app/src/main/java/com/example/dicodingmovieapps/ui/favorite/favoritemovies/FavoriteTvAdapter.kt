...
class FavoriteTvAdapter(private val moviesClickCallback: FavoriteMoviesClickCallback) :
    PagedListAdapter<TvEntity, FavoriteTvAdapter.TvViewHolder>(DIFF_CALLBACK) {
